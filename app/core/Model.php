...
abstract class Model {
    ...
    function add($conn, $dados, $tabela = null) {
        ...
        if (!is_array($dados)) {
            throw new Exception("Para poder inserir os dados precisam está em forma de array");
        }
        try {
    ...
    function edit($conn, $dados, $campo, $tabela = null) {
        ...
        if (!is_array($dados)) {
            throw new Exception("Para poder editar os dados precisam está em forma de array");
        }
        try {
            foreach ($dados as $chave => $valor) {
